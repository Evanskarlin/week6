...
function steam(arr) {
    // your code here
    var data = {
      'gta5' : {'nama' : "Grand Theft Auto V", 'harga' : "290000", 'genre' : "action"},
      'aco' : {'nama' : "Assassin's Creed Odyssey", 'harga' : "500000", 'genre' : "rpg"},
      'csgo' : {'nama' : "Counter Strike: Global Offensive", 'harga' : "120000", 'genre' : "first-person shooter"},
      'pubg' : {'nama' : "Playerunknown's Battlegrounds", 'harga' : "210000", 'genre' : "first-person shooter"},
      'mhw' : {'nama' : "Monster Hunter: World", 'harga' : "250000", 'genre' : "action"}
    }
    var hasil = {
      games: [],
      subTotal: 0
    ...
    for(var i = 0 ; i<arr.length ; i++){
      var obj = {}
      obj["title"] = data[arr[i]]["nama"]
      obj["genre"] = data[arr[i]]["genre"]
      hasil["games"].push(obj)
      hasil["subTotal"] += Number(data[arr[i]]["harga"])
    }
    return hasil
  }
